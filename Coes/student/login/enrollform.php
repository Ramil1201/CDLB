...
<?php
	...
	$query = mysqli_query($conn, "SELECT * FROM tbl_student WHERE student_id = '$Id'")or die(mysqli_error($conn));
...
?>
	...
	<div class="container my5">
		<br>
		<br>
		<a href="main.php" style="font-size: 16px; font-weight: bold;">Back</a>
		<div class="row">
			<div class="col-sm-4">
			</div>
			
			<br>
			<div class="col-sm-12" style="background: rgba(0, 0, 0, 0.03); border-radius: 15px;">
				<br>
				<br>
				...
				<form autocomplete="off">
					...
					<div class="form-group row">
						<div class="col-sm-12">
							...
							<input type="text" style="background: white;" name="address" class="form-control form-control-sm" value="<?=$row['address']?>" >
						</div>
					</div>
					<div class="form-group row">
						<div class="col-sm-4">
