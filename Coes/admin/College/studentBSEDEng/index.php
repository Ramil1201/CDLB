            ...
            <?php
              ...
              while($rows = $query->fetch_assoc()){
                ...
                "<tr>
                  ...
                  <td>".$rows['gender']."</td>
                  <td>
                  	<a href='../../../college/studentcs/info.php?id=".$rows['id']."' type='button' name='button' id='button' class='btn btn-info btn-sm' data-toggle='tooltip' data-placement='top' title='View Student Information'><span class='fas fa-list-alt'></span></a>

                    <a href='../../../college/requirementsCS.php?id=".$rows['id']."' type='button1' name='button1' id='button1' class='btn btn-primary btn-sm' data-toggle='tooltip' data-placement='top' title='Requirements'><span class='far fa-file-image'></span></a>
