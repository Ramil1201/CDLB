<?php
	...
	if(isset($_POST['edit'])){
		...
		$sql = "UPDATE `tbl_subjects` SET `subj_code`='$subj_code',`subj_description`='$subj_description',`subj_unit`='$subj_unit',`subj_prereq`='$subj_prereq',`subj_course`='$subj_course',`subj_major`='$subj_major',`subj_semester`='$subj_semester',`subj_year`='$subj_year' WHERE `subj_id` = '$subj_id'";
