		...
		$result = mysqli_query($conn, $query);
			...
			if ($result) {
				...
				$result1 = mysqli_query($conn, $query1);
					...
					if ($result1) {
						echo "<script type='text/javascript'>alert('Successfully Save!');window.location.href='../admin/oldstudent/oldCS/oldcs.php'</script>";
					}else{
						echo "<script type='text/javascript'>alert('Unsuccessfully Save!');window.location.href='../admin/oldstudent/oldCS/oldcs.php'</script>";
					}
